...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Manage instructor profiles and assignments</p>
        </div>
        <div>
                        ...
                        @forelse($instructors as $instructor)
                            <tr class="hover:bg-gray-50">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">
                                                {{ $instructor->users->first()->email ?? 'No email' }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        {{ \Illuminate\Support\Str::limit($instructor->address, 30) }}
                                    </div>
                                </td>
                                <td class="px-4 py-4">
                                    <div class="text-sm text-gray-900">
                                        {{ \Illuminate\Support\Str::limit($instructor->proficiency, 50) }}
                                    </div>
                                </td>
                                <td class="px-4 py-4 whitespace-nowrap">
                                    @php
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-500">
                                        {{ $instructor->classes->count() }}
                                    </div>
                                </td>
                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium actions-cell">
                                    <div class="action-buttons">
                                        <a href="{{ route('admin.instructors.show', $instructor) }}" class="text-blue-600 hover:text-blue-900">
                                        ...
                                        <a href="{{ route('admin.instructors.edit', $instructor) }}" class="text-indigo-600 hover:text-indigo-900">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path>
                                            </svg>
                                        </a>
                                        
                                        @if($instructor->users->first())
                                            <form action="{{ route('admin.instructors.toggle-status', $instructor) }}" method="POST" class="inline">
                                                @csrf
