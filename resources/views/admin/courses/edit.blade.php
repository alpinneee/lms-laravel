                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4 md:col-span-1">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Upload a new cover image (JPEG, PNG, GIF, max 2MB)</p>
                            @error('image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            <div class="aspect-w-16 aspect-h-9 bg-gray-100 rounded-md flex items-center justify-center">
                                @if($course->image)
                                    <img id="preview-image" src="{{ asset('storage/' . $course->image) }}" class="w-full h-full object-cover rounded-md" alt="{{ $course->course_name }}">
                                @else
                                    <div id="image-preview" class="text-center p-4">
                                        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                        <p class="mt-1 text-sm text-gray-500">No image currently set</p>
                                    </div>
