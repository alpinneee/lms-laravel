...
<div class="space-y-6">
    <!-- Page Header -->
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Create Course Type</h1>
        <p class="mt-1 text-sm text-gray-500">Add a new course type or category</p>
    </div>
            ...
            <form action="{{ route('admin.course-types.store') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="course_type" id="course_type" value="{{ old('course_type') }}" 
