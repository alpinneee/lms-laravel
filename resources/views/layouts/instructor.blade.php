...
<head>
    ...
    <title>@yield('title', 'Dashboard') - {{ config('app.name', 'Train4Best') }} Instructor</title>
...
<body class="h-full">
    <div class="min-h-full">
        ...
        <div class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200">
            @include('components.navbar.instructor-navbar')
        </div>
        
        <!-- Sidebar -->
        <div class="fixed top-16 left-0 bottom-0 z-40">
            @include('components.sidebars.instructor-sidebar')
        </div>
